package com.github.wouterman.springhateoas.web;
...
import com.github.wouterman.springhateoas.domain.model.ProductionOrder.ProductionOrderState;
...
public class ProductionOrderController implements
  ...
  record RenameRequest(@NonNull String newName) { }

  record CompleteRequest(@NonNull LocalDate expectedCompletionDate) {
